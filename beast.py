...
def build_level():
	...
	global board, beast_cnt, monster_cnt, egg_cnt, level, lives, score, points 
	...
	def main_menu_2():
		global mi3_shade, mi4_shade, mi5_shade, mi6_shade, mi7_shade, mi8_shade, BLOCK, block_type, KILLBLOCK, normalyellow, dangerousorange
	...
	def mi1_controls(opt):
		...
		if opt == 1:
			...
			KEY_RIGHT = 100
			KEY_LEFT = 97
			wasd = '\033[35m\033[2m> w,a,s,d <\033[37m'
			arrows = '[ arrows ]'
			vi = '[ h,j,k,l ]'
		elif opt == 2:
			KEY_UP = 259
			...
			KEY_LEFT = 260
			wasd = '[ w,a,s,d ]'
			arrows = '\033[35m\033[2m> arrows <\33[37m'
			vi = '[ h,j,k,l ]'
		elif opt == 3:
			KEY_UP = 107
			KEY_DOWN = 106
			...
			wasd = '[ w,a,s,d ]'
			arrows = '[ arrows ]'
			vi = '\033[35m\033[2m> h,j,k,l <\033[37m'
	...
	def mi2_controls(opt):
		...
		if opt == 1:
			pulling = 'toggle'
			toggle = '\033[2m\033[35m> toggle <\033[37m'
			single = '[ single ]'
			switch = '[ switch ]'
		elif opt == 2:
			pulling = 'single'
			toggle = '[ toggle ]'
			single = '\033[2m\033[35m> single <\033[37m'
			switch = '[ switch ]'
		elif opt == 3:
			pulling = 'switch'
			toggle = '[ toggle ]'
			single = '[ single ]'
			switch = '\033[2m\033[35m> switch <\033[37m'
	...
	def mi8_controls(opt):
		...
		if opt == 1:
			block_type = BLOCK
			normalyellow = '\033[2m\033[35m> Normal Yellow <\033[37m'
			dangerousorange = '[ Dangerous Orange ]'
		elif opt == 2:
			block_type = KILLBLOCK
			normalyellow = '[ Normal Yellow ]'
			dangerousorange = '\033[2m\033[35m> Dangerous Orange <\033[37m'
